...
| Перенос знаний между продуктами (что узнали циклы одного продукта — пригодилось в другом) | нет; метод живёт в границах продукта — журнал, состояние и реестры принадлежат своему продукту |
