...
4. Стековое ремесло (правила конкретного языка/фреймворка) — overlay продукта, не канон. Универсальные правила (границы модулей, ошибки, гонки, пирамида проверок) применяются в языке продукта.
