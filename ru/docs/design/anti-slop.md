...
Админка: плотность и честные таблицы. Лендинг: один оффер. Продукт: честные пустые состояния. Внутренний инструмент: плотность важнее маркетинга. Состав клиентов — решение проекта, см. `docs/process/stack.md`.
