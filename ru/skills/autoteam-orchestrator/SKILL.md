...
Роль, маршрут, субагенты, сделано, вердикты борда и число возвратов, журнал решений (автономный режим), ждёт человека (только жёсткие стопы), независимо продолжается, затраты цикла (время; токены/вызовы, если среда их отдаёт) — без цифр ретро не может судить, окупилась ли практика.
