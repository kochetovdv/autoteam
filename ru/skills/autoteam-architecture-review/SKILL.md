...
Порядок: ревизия кода и ADR → карта связей и данных → измерения (границы, владелец записи, гонки, роли на сервере, отказы/логи, KISS, мёртвые и недостижимые ветки — ловушки для будущих правок, долг с датой) → сравнение с прошлым отчётом → файл.
