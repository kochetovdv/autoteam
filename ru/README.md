...
Канонический язык — английский: [корень репозитория](../README.md). Эта папка — поддерживаемая ru-локаль, обновляется тем же коммитом, что канон; при расхождении прав английский текст.
...
Язык отчётов и вопросов человеку — язык человека проекта (по умолчанию язык поручения). Технический термин при первом появлении поясняй. Код и имена API не переводи.
...
| Ситуация | Skill |
|----------|--------|
| Поручения ещё нет: пустая папка, свежая копия канона, «что ты умеешь» | холодный старт: `autoteam-catalog` |
