...
4. Журнал решений docs/process/decisions.md (записи не переписываются, амендменты,
   свежие сверху). Состояние цикла docs/process/state.md по templates/state.md —
   новый цикл начинает новое состояние, а не продолжает прошлое.
